...
export default function Chart() {
  const commitActivity = useSelector(
    (state) => state?.reposdata?.contributeData,
  );
  // const commitActivity = chartData;

  const loadingContributors = useSelector(
    (state) => state.reposdata.loadingContribute,
  );
